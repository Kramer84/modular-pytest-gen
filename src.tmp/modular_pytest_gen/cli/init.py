...
def init_app(
    ...
    r"""
    Initialize the modular pytest generator configuration file
    
    Creates a default configuration file for modular pytest generation,
    inferring project structure from pyproject.toml if available. The
    configuration file specifies source code locations, import prefixes,
    and test generation strategies.
    
    Parameters
    ----------
    force : bool, optional (default is False)
        Flag to force overwrite of existing configuration file
    
    Raises
    ------
    typer.Exit : typer.Exit
        If configuration file already exists and force is not set
    
    Warnings
    --------
    The configuration file will overwrite any existing file if force is set
    to True
    """
