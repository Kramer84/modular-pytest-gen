...
app.command(name="run", help="Generate temporary pytest files via LLM inference.")(run_app)
app.command(name="merge", help="Consolidate verified temporary tests into final pytest files.")(merge_app)
app.command(name="clean", help="Remove temporary files and dry-run prompt artifacts.")(clean_app)
app.command(name="analyze", help="Generate a detailed report of successes and failures.")(analyze_app)
app.command(name="autodoc", help="Generate context-aware docstrings using a bottom-up DAG.")(autodoc_app)
